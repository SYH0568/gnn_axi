...
module AESL_automem_edge_attr_10_2_V (
    clk,
    rst,
    ce0,
    we0,
...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.example.autotvin_edge_attr_10_2_V.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.example.autotvout_edge_attr_10_2_V.dat"; 
//------------------------Local signal-------------------
