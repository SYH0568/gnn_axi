...
module AESL_automem_edge_index_11_0_V (
    clk,
    rst,
    ce0,
    we0,
...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.example.autotvin_edge_index_11_0_V.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.example.autotvout_edge_index_11_0_V.dat"; 
//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 14;
parameter ADDR_WIDTH = 32'd 7;
parameter DEPTH = 32'd 120;
parameter DLY = 0.1;
