...
module AESL_automem_node_attr_10_2_V (
    clk,
    rst,
    ce0,
    we0,
...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.example.autotvin_node_attr_10_2_V.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.example.autotvout_node_attr_10_2_V.dat"; 
//------------------------Local signal-------------------
