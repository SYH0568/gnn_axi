...
// ==============================================================
#ifndef __example_mul_mul_8hbi__HH__
#define __example_mul_mul_8hbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(example_mul_mul_8hbi) {
    ...
    SC_CTOR(example_mul_mul_8hbi):  ACMP_smul_us_U ("ACMP_smul_us_U") {
