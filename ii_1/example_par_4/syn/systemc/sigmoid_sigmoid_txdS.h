...
// ==============================================================
#ifndef __sigmoid_sigmoid_txdS_H__
#define __sigmoid_sigmoid_txdS_H__
...
struct sigmoid_sigmoid_txdS_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(sigmoid_sigmoid_txdS_ram) {
...
SC_MODULE(sigmoid_sigmoid_txdS) {
...
sigmoid_sigmoid_txdS_ram* meminst;


SC_CTOR(sigmoid_sigmoid_txdS) {
meminst = new sigmoid_sigmoid_txdS_ram("sigmoid_sigmoid_txdS_ram");
