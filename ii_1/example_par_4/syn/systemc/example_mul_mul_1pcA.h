...
// ==============================================================
#ifndef __example_mul_mul_1pcA__HH__
#define __example_mul_mul_1pcA__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(example_mul_mul_1pcA) {
    ...
    SC_CTOR(example_mul_mul_1pcA):  ACMP_smul_su_U ("ACMP_smul_su_U") {
