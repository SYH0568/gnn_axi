...
const sc_lv<16> Block_proc::ap_const_lv16_7BC = "11110111100";
const sc_lv<16> Block_proc::ap_const_lv16_1860 = "1100001100000";
const sc_lv<16> Block_proc::ap_const_lv16_C30 = "110000110000";
const sc_lv<16> Block_proc::ap_const_lv16_618 = "11000011000";
...
void Block_proc::thread_const_size_in_2() {
    const_size_in_2 = ap_const_lv16_1860;
}

void Block_proc::thread_const_size_in_2_ap_vld() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1)))) {
...
void Block_proc::thread_const_size_in_3() {
    const_size_in_3 = ap_const_lv16_C30;
}

void Block_proc::thread_const_size_in_3_ap_vld() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1)))) {
