...
// ==============================================================
#ifndef __example_mul_mul_9kbM__HH__
#define __example_mul_mul_9kbM__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(example_mul_mul_9kbM) {
    ...
    SC_CTOR(example_mul_mul_9kbM):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
