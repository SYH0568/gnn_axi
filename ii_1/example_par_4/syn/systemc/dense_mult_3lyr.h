...
struct dense_mult_3lyr : public sc_module {
    ...
    example_mul_mul_1ncg<1,1,14,7,21>* example_mul_mul_1ncg_U1591;
    example_mul_mul_1ocq<1,1,14,7,21>* example_mul_mul_1ocq_U1592;
    example_mul_mul_1ocq<1,1,14,7,21>* example_mul_mul_1ocq_U1593;
    example_mul_mul_1ocq<1,1,14,7,21>* example_mul_mul_1ocq_U1594;
    example_mul_mul_1ncg<1,1,14,7,21>* example_mul_mul_1ncg_U1595;
    example_mul_mul_1rcU<1,1,14,6,20>* example_mul_mul_1rcU_U1596;
    example_mul_mul_1ocq<1,1,14,7,21>* example_mul_mul_1ocq_U1597;
    example_mul_mul_1tde<1,1,14,6,20>* example_mul_mul_1tde_U1598;
    example_mul_mul_1sc4<1,1,14,8,21>* example_mul_mul_1sc4_U1599;
    example_mul_mul_1wdI<1,1,14,8,21>* example_mul_mul_1wdI_U1600;
    example_mul_mul_1ncg<1,1,14,7,21>* example_mul_mul_1ncg_U1601;
