...
// ==============================================================
#ifndef __example_mul_mul_8cud__HH__
#define __example_mul_mul_8cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(example_mul_mul_8cud) {
    ...
    SC_CTOR(example_mul_mul_8cud):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
