...
reg const_size_in_2_ap_vld;
reg const_size_in_3_ap_vld;
...
always @ (*) begin
    if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        const_size_in_2_ap_vld = 1'b1;
    end else begin
        const_size_in_2_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        const_size_in_3_ap_vld = 1'b1;
    end else begin
        const_size_in_3_ap_vld = 1'b0;
    end
end
...
assign const_size_in_1 = 16'd1980;

assign const_size_in_2 = 16'd6240;

assign const_size_in_3 = 16'd3120;

assign const_size_out_1 = 16'd1560;
